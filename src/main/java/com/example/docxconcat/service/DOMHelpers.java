...
public class DOMHelpers {
     ...
     * @since 8.8.1
     */
    public static Element createRangeWithText(String text, Node parentNode) {
     ...
     * @since 8.8.1
     */
    public static Element createRangeWithText(List<String> text, Node parentNode) {
        Document ownerDoc = parentNode.getOwnerDocument();
     ...
     * @since 8.8.1
     */
    public static void splitParagraphForAltChunk(String id, Node bookmarkStart) {
     ...
     * @since 8.8.1
     */
    public static Element createBookmarkEnd(Node bookmarkStart) {
     ...
     * @since 8.8.1
     */
    public static void insertNodeAfter(Node nodeToInsert, Node refNode) {
     ...
     * @since 8.8.1
     */
    public static boolean isBookmarkEnd(Node node) {
     ...
     * @since 8.8.1
     */
    public static boolean isBookmarkStart(Node node) {
     ...
     * @since 8.8.1
     */
    public static boolean isTagName(Node node, String tag) {
     ...
     * @since 8.8.1
     */
    public static String getIdFromNode(Node node) {
     ...
     * @since 8.8.1
     */
    public static String getNameFromNode(Node node) {
     ...
     * @since 8.8.1
     */
    public static List<Node> collectAllNodes(Node root, String name) {
     ...
     * @since 8.8.1
     */
    public static Node clonePreviousRPr(Node node) {
     ...
     * @since 8.8.1
     */
    public static Node clonePreviousPPr(Node node) {
     ...
     * @since 8.8.1
     */
    public static Node clonePreviousNodeOfType(Node node, String nodeName) {
        Node result = null;
        boolean repeat = true;
